...
const EventInformationScreenCorporate = () => {
  ...
  const [eventName, setEventName] = useState("Corporate Retreat");
  const [eventDate, setEventDate] = useState('May 30, 2025');
  const [eventTime, setEventTime] = useState('6:00 PM');
  const [eventType, setEventType] = useState('Corporate');
  const [description, setDescription] = useState('A great evening to celebrate success and strengthen connections.');
